...
void AdcInit(uint8_t flg_enable) {
  ...
  if(flg_enable) {
    ...
    R8_ADC_CHANNEL = CH_EXTIN_0;
#if 0 // TEST_2_ADC_CHANNEL
    R32_ADC_SCAN_CFG1 = ( R32_ADC_SCAN_CFG1 & (~RB_ADC_SCAN_CH1 | RB_ADC_SCAN_CH2))
        | CH_EXTIN_1 | (CH_EXTIN_2 << 8);
    R32_ADC_SCAN_CFG2 = (R32_ADC_SCAN_CFG2 & (~RB_ADC_SCAN_QUAN))
        | (2<<16);
#endif
